export default function BlogSidebar() {
  return (
    <>
      <section className="pt-[180px] pb-[120px] overflow-hidden">
        <div className="container">
          <div className="flex flex-wrap mx-[-16px]">
            <div className="w-full lg:w-8/12 px-4">
              <div>
                <h2 className="font-bold text-black dark:text-white text-3xl sm:text-4xl leading-tight sm:leading-tight mb-8">
                  10 amazing sites to download stock photos & digital assets for free
                </h2>
                <div
                  className="flex flex-wrap items-center justify-between pb-4 mb-10 border-b border-body-color border-opacity-10 dark:border-white dark:border-opacity-10">
                  ...
                  <div className="mb-5">
                    <span
                      className="bg-primary rounded-full inline-flex items-center justify-center py-2 px-4 font-semibold text-sm text-white">
                      Design </span>
                  </div>
                </div>
                <div>
                  ...
                  <h3
                    className="font-bold text-black dark:text-white font-xl sm:text-2xl lg:text-xl xl:text-2xl leading-tight sm:leading-tight lg:leading-tight xl:leading-tight mb-10">
                  ...
                  <div
                    ...
                    <span className="absolute right-0 bottom-0 z-[-1]">
                      <svg width="53" height="30" viewBox="0 0 53 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <mask id="mask0_111:596" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="75"
                          height="75">
                          <circle opacity="0.8" cx="37.5" cy="37.5" r="37.5" fill="#4A6CF7" />
                        </mask>
            ...
            <div className="w-full lg:w-4/12 px-4">
              ...
              <div className="bg-primary bg-opacity-5 dark:bg-opacity-10 rounded-md mb-10">
                <h3
                  className="font-semibold text-black dark:text-white text-lg py-4 px-8 border-b border-body-color border-opacity-10 dark:border-white dark:border-opacity-10">
                  Related Posts
                </h3>
                <ul className="p-8">
                  <li
                    className="pb-6 mb-6 border-b border-body-color border-opacity-10 dark:border-white dark:border-opacity-10">
                    <div className="flex lg:block xl:flex items-center">
                      <div className="max-w-[85px] w-full h-[75px] rounded-md overflow-hidden mr-5 lg:mb-3 xl:mb-0">
                        <img src="images/post-01.jpg" alt="image" />
                      </div>
                      <div className="w-full">
                        <h5>
                          <a href="#"
                            className="font-medium text-black dark:text-white text-base leading-snug block mb-[6px] hover:text-primary dark:hover:text-primary">
              ...
              <div
                className="relative z-10 rounded-md bg-primary bg-opacity-[3%] dark:bg-opacity-10 p-8 sm:p-11 lg:p-8 xl:p-11 wow fadeInUp"
                data-wow-delay=".2s
              ">
