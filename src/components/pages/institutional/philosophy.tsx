...
export default function Philosophy() {
  ...
  pageTitle(`${t('title')} - ${t('philosophy.title')}`)
          ...
          <div className="flex flex-wrap items-center mx-[-16px]">
            <div className="w-full md:w-8/12 lg:w-7/12 px-4">
              <div className="max-w-[570px] mb-12 md:mb-0">
                <h1 className="font-bold text-black dark:text-white text-2xl sm:text-3xl mb-5">{t('philosophy.title')}</h1>
              </div>
            </div>
            <div className="w-full md:w-4/12 lg:w-5/12 px-4">
              <div className="text-end">
                <BreadCrumb titlePage={t('philosophy.title')} />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-wrap items-center mx-[-16px]">
            <div className="w-full px-4">
              <div className="mb-12 md:mb-0">
                ...
                <p key={`p1`} className="font-medium text-bodyColor text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-11">
                  {t(`philosophy.p1`)}
                </p>
                <h3 key="st2" className="font-bold text-black dark:text-white text-lg sm:text-sm my-5">
                  {t('philosophy.st2')}
                </h3>
                <p key={`p2`} className="font-medium text-bodyColor text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-11">
                  {t(`philosophy.p2`)}
                </p>
                <h3 key="st3" className="font-bold text-black dark:text-white text-lg sm:text-sm my-5">
                  {t('philosophy.st3')}
                </h3>
                <p key={`p3`} className="font-medium text-bodyColor text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-11">
                  {t(`philosophy.p3`)}
                </p>
                <h3 key="st4" className="font-bold text-black dark:text-white text-lg sm:text-sm my-5">
                  {t('philosophy.st4')}
                </h3>
                <p key={`p4`} className="font-medium text-bodyColor text-base sm:text-lg leading-relaxed sm:leading-relaxed mb-11">
                  {t(`philosophy.p4`)}<br />
                  {t(`philosophy.p5`)}<br />
                  {t(`philosophy.p6`)}
                </p>
